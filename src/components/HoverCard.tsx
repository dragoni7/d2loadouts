...
const HoverCard: React.FC<HoverCardProps> = ({ item, children }) => {
  ...
  const renderStatImage = (stat: string) => {
    switch (stat) {
      case 'Mobility':
        return <img src="/assets/mob.png" width="10%" />;
      case 'Recovery':
        return <img src="/assets/rec.png" width="10%" />;
      case 'Resilience':
        return <img src="/assets/res.png" width="10%" />;
      case 'Discipline':
        return <img src="/assets/disc.png" width="10%" />;
      case 'Intellect':
        return <img src="/assets/int.png" width="10%" />;
      case 'Strength':
        return <img src="/assets/str.png" width="10%" />;
    }
  };
